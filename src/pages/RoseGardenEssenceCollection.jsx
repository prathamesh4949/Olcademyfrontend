  ...
  const ScentCard = memo(({ scent }) => {
    ...
    return (
      ...
      >
        ...
        {/* Collection Badge */}
        <div className="absolute top-4 left-4 bg-gradient-to-r from-green-500 to-teal-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md z-10 flex items-center space-x-1">
          <Leaf size={12} />
        ...
        <div className="space-y-3 flex-1">
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div className="bg-green-500/10 dark:bg-green-400/10 px-2 py-1 rounded-full">
              <span className="text-xs text-green-700 dark:text-green-400 font-medium">ROSE GARDEN</span>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F5F0] dark:bg-gray-900">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-green-500 via-teal-500 to-cyan-600 text-white py-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                Immerse yourself in the enchanting world of rose-inspired fragrances. Delicate, romantic, and utterly captivating.
              </p>
            </motion.div>
          </div>
        </section>
