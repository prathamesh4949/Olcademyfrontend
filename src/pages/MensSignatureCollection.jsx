...
const MensSignatureCollection = () => {
  ...
  // Quick View Modal (reusing the same structure with updated colors)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-black to-gray-800">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-purple-800 via-indigo-800 to-blue-900 text-white py-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                Discover our exclusive men's signature fragrances. These sophisticated scents 
                define masculine elegance and leave a lasting impression.
              </p>
            </motion.div>
          </div>
        </section>
