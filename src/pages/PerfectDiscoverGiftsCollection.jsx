...
const PerfectDiscoverGiftsCollection = () => {
  ...
  // Fetch perfect discover gifts scents
  const fetchPerfectDiscoverGifts = useCallback(async () => {
    try {
      ...
      console.error('Error fetching perfect discover gifts:', err);
...
const ScentCard = memo(({ scent, addToCart, isInCart, toggleWishlist, isInWishlist, navigate, addNotification, setIsCartOpen }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 text-left relative border border-pink-200 dark:border-gray-600 group cursor-pointer backdrop-blur-sm flex flex-col"
    ...
    >
      ...
      <motion.button
        ...
        className="absolute top-4 right-4 text-purple-600 hover:text-red-600 dark:text-pink-400 dark:hover:text-red-400 z-10 bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-full p-2 shadow-md transition-all duration-200"
      ...
      <AnimatePresence>
        {isHovered && (
          ...
          >
            <Eye size={18} className="text-purple-600 dark:text-pink-400" />
          </motion.button>
        )}
      </AnimatePresence>
      ...
      {/* Perfect Gift Badge */}
      <div className="absolute top-4 left-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md z-10 border border-purple-400 flex items-center space-x-1">
        <Gift size={12} />
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 bg-gradient-to-t from-purple-900/30 to-transparent rounded-xl flex items-end justify-center pb-4"
            >
              <span className="text-white text-sm font-medium bg-purple-600/70 px-3 py-1 rounded-full backdrop-blur-sm">
      ...
      <div className="space-y-3 flex-1">
        <div className="flex items-start justify-between">
          <h3 className="text-xl font-alata text-purple-900 dark:text-gray-200 font-bold leading-tight">
        ...
        {scent.description && (
          <p className="text-sm text-purple-700 dark:text-gray-400 leading-relaxed line-clamp-2">
            {scent.description}
          </p>
        )}
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          ...
          {scent.intensity && (
            <span className="bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 px-2 py-1 rounded-full capitalize">
              {scent.intensity}
            </span>
          )}
          {scent.concentration && (
            <span className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-2 py-1 rounded-full capitalize">
              {scent.concentration}
            </span>
          )}
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex flex-col">
            <p className="text-xl font-bold text-purple-600 dark:text-pink-400">
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:bg-gradient-to-r dark:from-purple-400/10 dark:to-pink-400/10 px-2 py-1 rounded-full">
            <span className="text-xs text-purple-700 dark:text-purple-400 font-medium flex items-center space-x-1">
              <Sparkles size={10} />
              <span>DISCOVER</span>
            </span>
          </div>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-purple-600 dark:text-pink-400">
                Quick View
              </h3>
              <button
                onClick={handleClose}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-2xl font-bold text-purple-600 dark:text-pink-400">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 dark:bg-gray-900">
      <Header />
      <NotificationSystem />
      <QuickViewModal />
      {/* CART SIDEBAR */}
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-purple-600 via-pink-600 to-indigo-700 text-white py-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                Curated discovery sets and samples perfect for introducing someone to new fragrances. 
                Let them explore and find their perfect scent match.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <>
                <div className="mb-6 text-center">
                  <p className="text-gray-600 dark:text-gray-400">
                    Showing {scents.length} perfect discovery gift options
                  </p>
                </div>
