  ...
  const ScentCard = memo(({ scent }) => {
    ...
    return (
      <motion.div
        ...
        className="bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-100 dark:from-orange-900/30 dark:to-amber-900/30 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 text-left relative border border-orange-200 dark:border-orange-700 group cursor-pointer backdrop-blur-sm flex flex-col"
      ...
      >
        ...
        <motion.button
          ...
          className="absolute top-4 right-4 text-orange-700 hover:text-red-600 dark:text-orange-300 dark:hover:text-red-400 z-10 bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-full p-2 shadow-md transition-all duration-200"
        ...
        <AnimatePresence>
          {isHovered && (
            ...
            >
              <Eye size={18} className="text-orange-700 dark:text-orange-300" />
            </motion.button>
          )}
        </AnimatePresence>

        {/* Collection Badge */}
        <div className="absolute top-4 left-4 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md z-10 flex items-center space-x-1">
          <Sunrise size={12} />
          <span>MARMALADE</span>
        </div>
        ...
        <div className="space-y-3 flex-1">
          <div className="flex items-start justify-between">
            <h3 className="text-xl font-alata text-orange-900 dark:text-orange-200 font-bold leading-tight">
          ...
          {scent.description && (
            <p className="text-sm text-orange-800 dark:text-orange-300 leading-relaxed line-clamp-2">
              {scent.description}
            </p>
          )}
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex flex-col">
              ...
              {scent.originalPrice && scent.originalPrice > scent.price && (
                <p className="text-sm text-orange-600 dark:text-orange-400 line-through">
                  ${scent.originalPrice.toFixed(2)}
                </p>
              )}
            </div>
            <div className="bg-orange-500/10 dark:bg-orange-400/10 px-2 py-1 rounded-full">
              <span className="text-xs text-orange-700 dark:text-orange-400 font-medium">CITRUS BURST</span>
            </div>
          </div>
        </div>
