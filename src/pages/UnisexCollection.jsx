        ...
        >
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
            <div className="text-left">
              ...
              <h2 className="text-[42px] font-dm-serif mb-6 dark:text-white">{banner.title}</h2>
      ...
      <main>
          ...
          >
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <h2 className="text-[42px] font-dm-serif mb-6 dark:text-white">Scents Without Limits</h2>
                <p className="text-[18px] mb-6 text-[#5a2408] dark:text-gray-300 leading-relaxed">
        ...
        {banners.collection_highlight.length > 0 ? (
          ...
          >
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              <div className="text-left">
                <h3 className="text-lg text-[#79300f] font-semibold uppercase mb-3 dark:text-[#f6d110]">Premium Collection</h3>
                <h2 className="text-[42px] font-dm-serif mb-6 dark:text-white">
                  CRAFTED FOR <br />
