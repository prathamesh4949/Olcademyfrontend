  ...
  useEffect(() => {
    const fetchUnisexData = async () => {
      try {
        ...
        console.log('🔍 Fetching unisex collection data...');
        
        // Fetch both products and banners
        const [productsResponse, bannersResponse] = await Promise.all([
          ProductService.getUnisexCollections().catch(err => {
            console.error('Products fetch error:', err);
            return { success: false, error: err.message };
          }),
          ProductService.getUnisexBanners().catch(err => {
            console.error('Banners fetch error:', err);
            return { success: false, error: err.message };
          })
        ]);
        
        console.log('Unisex Products Response:', productsResponse);
        console.log('Unisex Banners Response:', bannersResponse);
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div className="bg-[#79300f]/10 dark:bg-[#f6d110]/10 px-2 py-1 rounded-full">
              <span className="text-xs text-[#79300f] dark:text-[#f6d110] font-medium">
                {product.brand?.toUpperCase() || 'UNISEX'}
              </span>
            </div>
          </div>
        </div>
              ...
              <div className="overflow-hidden">
                ...
                >
                  {products.map((product, idx) => {
                    ...
                    return (
                      <ProductCard key={product._id} product={product} isCompact={true} collectionName={title} />
                    );
                  })}
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#79300f]/10 to-[#5a2408]/10 rounded-2xl p-8">
                <img
                  src={banner.image || '/images/newimg3.PNG'}
                  alt={banner.altText || banner.title}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <img
                  ...
                  alt={quickViewProduct.name || 'Perfume'}
              ...
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100">
                  {quickViewProduct.name || 'Unnamed Perfume'}
                </h4>
      ...
      <main>
        ...
        >
          ...
          >
            ...
            Each scent is designed to be worn by anyone, celebrating the art of perfumery without gender constraints.
          </motion.p>
        </motion.section>
              ...
              <div className="absolute inset-0 flex items-center justify-start pl-12">
                <div className="text-white max-w-2xl">
                  <h2 className="text-[48px] font-dm-serif mb-6 leading-tight">
                    Gender-Free <br />
                    <span className="text-[#f6d110]">Fragrance</span>
                  </h2>
                  <p className="text-[20px] mb-8 text-gray-200">
                    Break the boundaries with our unisex collection. These sophisticated scents are crafted 
                    for everyone who appreciates the art of fine fragrance, regardless of gender.
                  </p>
                  <Button 
                    className="bg-gradient-to-r from-[#79300f] to-[#5a2408] hover:from-[#5a2408] hover:to-[#79300f] text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  >
        ...
        {banners.product_highlight.length > 0 ? (
          ...
          >
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                <h3 className="text-lg text-[#79300f] dark:text-[#f6d110] font-semibold uppercase mb-3">Signature Collection</h3>
                <h2 className="text-[42px] font-dm-serif mb-6 text-[#79300f] dark:text-[#f6d110]">
                  Scents Without Limits
                </h2>
                <p className="text-[18px] mb-6 text-[#5a2408] dark:text-gray-300 leading-relaxed">
                  Our unisex fragrances celebrate the freedom of scent expression. From fresh and woody to 
                  warm and spicy, each fragrance tells a unique story that resonates with individual style.
                </p>
                <Button 
                  className="bg-gradient-to-r from-[#79300f] to-[#5a2408] hover:from-[#5a2408] hover:to-[#79300f] text-white px-8 py-4 text-lg font-semibold rounded-xl"
                >
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-[#f6d110]/20 to-[#79300f]/20 rounded-2xl p-8">
                  <img
                    ...
                    alt="Signature Unisex Collection"
                    className="w-full h-[400px] object-contain rounded-xl shadow-lg"
                  />
                </div>
              </div>
